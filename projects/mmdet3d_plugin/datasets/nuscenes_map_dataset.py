...
import json
from .lidar_instance_lines import LiDARInstanceLines
...
class CustomNuScenesLocalMapDataset(CustomNuScenesDataset):
    ...
    def prepare_train_data(self, index):
        ...
        ####### KOJI #######
        img_metas_tmp = example['img_metas'].data

        # # Necessary info
        # del img_metas_tmp['can_bus']
        # del img_metas_tmp['img_shape']
        # del img_metas_tmp['lidar2img']

        # # Just in case
        # del img_metas_tmp['img_norm_cfg']
        # del img_metas_tmp['sample_idx']
        # del img_metas_tmp['filename']

        # Not necessary at this moment
        del img_metas_tmp['lidar2global']
        del img_metas_tmp['lidar2ego']
        del img_metas_tmp['pad_shape']
        del img_metas_tmp['ori_shape']
        del img_metas_tmp['scale_factor']
        del img_metas_tmp['box_mode_3d']
        del img_metas_tmp['box_type_3d']
        del img_metas_tmp['pts_filename']
        del img_metas_tmp['img_aug_matrix']
        del img_metas_tmp['prev_idx']
        del img_metas_tmp['next_idx']
        del img_metas_tmp['scene_token']
        del img_metas_tmp['camera2ego']
        del img_metas_tmp['camera_intrinsics']
        ####### KOJI #######
